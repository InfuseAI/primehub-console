...
const defaultConfigs = {
  ...
  locale: 'en',
  version: 'LOCAL',
  keycloakApiBaseUrl: 'http://127.0.0.1:8080',
  keycloakOidcBaseUrl: 'http://127.0.0.1:8080',
  keycloakRealmName: 'master',
  keycloakGrantType: 'password',
  keycloakUsername: 'wwwy3y3',
  keycloakPassword: 'wwwy3y3',
  keycloakEveryoneGroupId: 'EGUpxErEqjy2baz5bi85QDjiNXp14tPP',
...
export const createConfig = (): Config => {
  const envConfigs = pickBy({
    ...
    keycloakGrantType: "authorization_code",
    // keycloakGrantType: "password",
    ...
    keycloakPassword: "1234",
    // keycloakEveryoneGroupId: process.env.KC_EVERYONE_GROUP_ID,
    keycloakEveryoneGroupId: "feaf4e9c-cea2-4697-b17f-c80141cb28b1",
    // keycloakClientId: process.env.KC_CLIENT_ID,
    keycloakClientId: "hung",
    keycloakClientSecret: "33CjE9SPlWPn9m3etKnJyLf6Oa4KfrxX",
