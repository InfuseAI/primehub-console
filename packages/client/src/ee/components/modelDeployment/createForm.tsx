        ...
        <Row gutter={16}>
          <Col xs={24} sm={16} lg={16}>
            ...
            <Card loading={loading} style={{overflow: 'auto'}}>
              ...
              <Form.Item label={(<span>Model URI <PHTooltip tipText={`The location where the trained model is stored with MLflow version ${window?.mlflowVersion}; based on this model file to deploy a model image.`} tipLink='https://docs.primehub.io/docs/model-deployment-model-uri' placement='right' style={{margintLeft: 8}}/></span>)}>
