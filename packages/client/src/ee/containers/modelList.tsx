    ...
    if (error) {
      if (get(error, 'graphQLErrors.0.extensions.code') === 'TRACKING_URI_NOT_FOUND') {
        pageBody = <Alert
          ...
          description={<span>MLflow settings are not configured yet. Please go to the group settings to configure it. <a href='https://docs.primehub.io/docs/model-configuration'>Learn more</a></span>}
          type="warning"
          showIcon/>;
