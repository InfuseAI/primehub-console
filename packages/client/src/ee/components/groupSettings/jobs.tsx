  ...
  submit = e => {
    ...
    form.validateFields(async (err, values: FormValue) => {
      ...
      updateGroup({
        ...
        group.jobDefaultActiveDeadlineSeconds =
          values.jobDefaultActiveDeadlineSeconds;
        form.setFieldsValue({
      ...
      <Form onSubmit={this.submit}>
        <Row style={{ marginLeft: 5, marginRight: 5 }}>
          <Col>
            ...
            <Form.Item
              style={{ textAlign: 'right', marginTop: 20, marginBottom: 5 }}
            >
    ...
    options: (props: Props) => ({
      onCompleted: (data: any) => {
        notification.success({
          ...
          message: 'Success!',
          description: <>Group '{data.updateGroup.name}' updated.</>,
        });
      },
