  ...
  renderInfoQuotaCard(title: string, quota) {
    return (
      <Card title={title}>
        <Row>
          <Col sm={8} xs={24}>
            {this.renderInfoQuotaFormItem('CPU Quota', quota.cpu, {
              min: 0.5,
              step: 0.5,
              percision: 1,
            })}
          ...
          <Col sm={8} xs={24}>
            {this.renderInfoQuotaFormItem('GPU Quota', quota.gpu, {
              min: 0,
              step: 1,
              percision: 0,
            })}
          ...
          <Col sm={8} xs={24}>
            {this.renderInfoQuotaFormItem('Memory Quota', quota.memory, {
              min: 0,
              step: 1,
              precision: 1,
              unit: ' GB',
