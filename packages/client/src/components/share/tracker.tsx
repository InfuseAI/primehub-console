...
const CommunityList = (props) => {
  ...
  return (
    <div>
      <p><Icon type="twitter" /><a href="https://twitter.com/intent/tweet?text=%40infuseai%20PrimeHub%20is%20awesome%21" target="_blank" onClick={()=>{userTakeAction('twitter')}}>Share To Twitter</a></p>
      <p><Icon type="user-add" /><a href="https://discord.gg/G2kudBanAa" target="_blank" onClick={()=>{userTakeAction('discord')}}>Join our Discord</a></p>
    </div>
  )
}
