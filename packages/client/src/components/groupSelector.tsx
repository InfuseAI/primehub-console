  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <Select size={'small'} value={groups && groups.length > 0 ? currentGroupName : "None"} placeholder="Please select a group" onChange={this.handleChange} style={{width: "160px", fontSize: "12px"}}>
